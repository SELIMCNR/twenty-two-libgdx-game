package com.selimcinar.survivorbird;
...
public class SurvivorBird extends ApplicationAdapter {
	...
	@Override
	public void create () {
		rainMusic = Gdx.audio.newMusic(Gdx.files.internal("mars.mp3"));
		rainMusic.setLooping(true);
		rainMusic.play();
		batch = new SpriteBatch();
		background = new Texture("background.png");
		bird = new Texture("bird.png");
		bee1 = new Texture("enemy-frame1.png");
		bee2 = new Texture("skull_in_a_ufo_spacecraft.png");
